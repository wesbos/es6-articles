In JavaScript, when you want to put a variable inside a string, it's a pain in the ass because you have to stop your string, concatenate on the variable, and then open your string again and keep going.
